...
var author$project$Main$ShowingNeither = {$: 'ShowingNeither'};
...
var author$project$Main$initialModel = {
	blocksOn: false,
	showing: author$project$Main$ShowingNeither,
	triangle: elm$core$Array$fromList(
		_List_fromArray(
			['1', '11', '101']))
};
var author$project$Main$ShowingCalculation = {$: 'ShowingCalculation'};
var author$project$Main$ShowingCalculationAndResult = {$: 'ShowingCalculationAndResult'};
var elm$core$Basics$truncate = _Basics_truncate;
var author$project$Main$isInteger = function (f) {
	return !((f | 0) - f);
};
...
var author$project$Main$lastFermatNumberIndex = function (triangle) {
	var n = A2(
		elm$core$Basics$logBase,
		2,
		elm$core$Array$length(triangle));
	return author$project$Main$isInteger(n) ? A2(
		elm$core$Basics$pow,
		2,
		elm$core$Basics$floor(n) - 1) : A2(
		elm$core$Basics$pow,
		2,
		elm$core$Basics$floor(n));
};
...
var author$project$Main$optimisticGet = F2(
	function (n, array) {
		var _n0 = A2(elm$core$Array$get, n, array);
		if (_n0.$ === 'Just') {
			var element = _n0.a;
			return element;
		} else {
			return _Debug_todo(
				...
				'optimisticGet found Nothing for index: ' + elm$core$String$fromInt(n));
		}
	});
var author$project$Main$lastFermatNumber = function (triangle) {
	return A2(
		author$project$Main$optimisticGet,
		author$project$Main$lastFermatNumberIndex(triangle),
		triangle);
};
...
var author$project$Main$multiply = F2(
	function (fermat, s) {
		...
		return _Utils_Tuple2(
			_Utils_ap(
				s,
				_Utils_ap(remainingFermatDigits, s)),
...
var author$project$Main$nthFermatNumber = function (n) {
	return '1' + (A2(
		elm$core$String$repeat,
		A2(elm$core$Basics$pow, 2, n) - 1,
		'0') + '1');
};
var author$project$Main$nextLine = function (triangle) {
	var numberOfLines = elm$core$Array$length(triangle);
	var n = A2(elm$core$Basics$logBase, 2, numberOfLines);
	if (author$project$Main$isInteger(n)) {
		return author$project$Main$nthFermatNumber(
			elm$core$Basics$floor(n));
	} else {
		var lineToMultiply = A2(
			author$project$Main$optimisticGet,
			numberOfLines - author$project$Main$lastFermatNumberIndex(triangle),
			triangle);
		var _n0 = A2(
			author$project$Main$multiply,
			author$project$Main$lastFermatNumber(triangle),
			lineToMultiply);
		var result = _n0.a;
		return result;
	}
...
var author$project$Main$update = F2(
	function (msg, model) {
		var nextTriangleLine = author$project$Main$nextLine(model.triangle);
		switch (msg.$) {
			case 'Step':
				var _n1 = model.showing;
				switch (_n1.$) {
					case 'ShowingNeither':
						return _Utils_update(
							model,
							{showing: author$project$Main$ShowingCalculation});
					case 'ShowingCalculation':
						return _Utils_update(
							model,
							{showing: author$project$Main$ShowingCalculationAndResult});
					default:
						return _Utils_update(
							model,
							{
								showing: author$project$Main$ShowingNeither,
								triangle: A2(elm$core$Array$push, nextTriangleLine, model.triangle)
							});
				}
			case 'ToggleBlocks':
				return _Utils_update(
					model,
					{blocksOn: !model.blocksOn});
			default:
...
var author$project$Main$ToggleBlocks = {$: 'ToggleBlocks'};
var author$project$Main$isPowerOf2 = function (n) {
	return author$project$Main$isInteger(
		A2(elm$core$Basics$logBase, 2, n));
};
var author$project$Main$blue = '#6495ED';
...
var author$project$Main$colorStylesIfAllowedForModel = F2(
	function (model, color) {
		return model.blocksOn ? _List_Nil : _List_fromArray(
			[
				A2(elm$html$Html$Attributes$style, 'color', color)
			]);
	});
var author$project$Main$currentMultiplicand = function (triangle) {
	var index = (elm$core$Array$length(triangle) - author$project$Main$lastFermatNumberIndex(triangle)) - 1;
	return A2(author$project$Main$optimisticGet, index, triangle);
};
var author$project$Main$red = '#8B0000';
var author$project$Main$green = '#006400';
var author$project$Main$orange = '#FF8C00';
var author$project$Main$white = '#FFFFFF';
...
var author$project$Main$renderStringAsSpans = F2(
	function (model, s) {
		var blockCharStyles = function (_char) {
			if (model.blocksOn) {
				switch (_char.valueOf()) {
					case '0':
						return _List_fromArray(
							[
								A2(elm$html$Html$Attributes$style, 'background-color', author$project$Main$orange)
							]);
					case '1':
						return _List_fromArray(
							[
								A2(elm$html$Html$Attributes$style, 'background-color', author$project$Main$green),
		...
		var charToSpan = function (_char) {
			return A2(
				elm$html$Html$span,
				blockCharStyles(_char),
				_List_fromArray(
					[
						elm$html$Html$text(
...
var author$project$Main$stackedDiv = F4(
	function (model, additionalStyles, top, bottom) {
		return A2(
			elm$html$Html$div,
			A2(
			...
			_List_fromArray(
				[
					...
					elm$html$Html$div,
					_List_Nil,
					A2(author$project$Main$renderStringAsSpans, model, top)),
					A2(
					elm$html$Html$div,
					_List_fromArray(
						[
...
var prikhi$decimal$Decimal$toCommonExponent = function (_n0) {
	var a = _n0.a;
	var b = _n0.b;
	var _n1 = b;
	var mb = _n1.a;
...
var prikhi$decimal$Decimal$add = F2(
	function (a, b) {
		var _n0 = prikhi$decimal$Decimal$toCommonExponent(
			_Utils_Tuple2(a, b));
		var ra = _n0.a;
		var rb = _n0.b;
		var _n1 = rb;
...
var author$project$Main$toDecimal = function (s) {
	var reversedChars = elm$core$List$reverse(
		elm$core$String$toList(s));
	var valuesAndChars = A2(
		elm$core$List$indexedMap,
		F2(
			function (i, _char) {
				return _Utils_Tuple2(
					prikhi$decimal$Decimal$fromInt(
	...
	var values = A2(
		...
		A2(
			...
			valuesAndChars));
	return A3(elm$core$List$foldl, prikhi$decimal$Decimal$add, prikhi$decimal$Decimal$zero, values);
};
...
var prikhi$decimal$Decimal$toString = function (_n0) {
	var m = _n0.a;
	var e = _n0.b;
	var sign = A2(
	...
	var _n1 = A2(elm$core$Basics$compare, e, 0);
	switch (_n1.$) {
		case 'EQ':
...
var author$project$Main$toDecimalString = A2(elm$core$Basics$composeL, prikhi$decimal$Decimal$toString, author$project$Main$toDecimal);
var author$project$Main$renderCalculationSpans = function (model) {
	var multiplicand = author$project$Main$currentMultiplicand(model.triangle);
	var fermat = author$project$Main$lastFermatNumber(model.triangle);
	var colorStylesFor = author$project$Main$colorStylesIfAllowedForModel(model);
	return _List_fromArray(
		[
			A2(
			elm$html$Html$span,
			...
			A4(
			author$project$Main$stackedDiv,
			model,
			colorStylesFor(author$project$Main$red),
			fermat,
			author$project$Main$toDecimalString(fermat)),
			A2(
			elm$html$Html$span,
			_List_Nil,
			_List_fromArray(
			...
			author$project$Main$stackedDiv,
			model,
			colorStylesFor(author$project$Main$blue),
			multiplicand,
			author$project$Main$toDecimalString(multiplicand))
		]);
};
var author$project$Main$renderRowDiv = F3(
	function (model, index, line) {
		var showingLastLine = _Utils_eq(model.showing, author$project$Main$ShowingCalculationAndResult);
		var showingCalculation = _Utils_eq(model.showing, author$project$Main$ShowingCalculation) || _Utils_eq(model.showing, author$project$Main$ShowingCalculationAndResult);
		var multiplicand = author$project$Main$currentMultiplicand(model.triangle);
		var isLastLine = _Utils_eq(
			index,
			elm$core$Array$length(model.triangle) - 1);
		var fermat = author$project$Main$lastFermatNumber(model.triangle);
		var colorStylesFor = author$project$Main$colorStylesIfAllowedForModel(model);
		var lineStyles = A2(
			elm$core$List$append,
			...
			_Utils_eq(
				line,
				author$project$Main$lastFermatNumber(model.triangle)) ? colorStylesFor(author$project$Main$red) : (_Utils_eq(
				line,
				author$project$Main$currentMultiplicand(model.triangle)) ? colorStylesFor(author$project$Main$blue) : _List_Nil));
		var _n0 = A2(author$project$Main$multiply, fermat, multiplicand);
		var product = _n0.a;
		var remainingFermatDigits = _n0.b;
		var renderLastLineAsSpans = _List_fromArray(
			[
				A2(
				elm$html$Html$span,
				colorStylesFor(author$project$Main$blue),
				A2(author$project$Main$renderStringAsSpans, model, multiplicand)),
				A2(
				elm$html$Html$span,
				colorStylesFor(author$project$Main$red),
				A2(author$project$Main$renderStringAsSpans, model, remainingFermatDigits)),
				A2(
				elm$html$Html$span,
				colorStylesFor(author$project$Main$blue),
				A2(author$project$Main$renderStringAsSpans, model, multiplicand))
				...
				[
					...
					_List_fromArray(
						[
							...
							'visibility',
							(!showingLastLine) ? 'hidden' : '')
						]),
					_List_fromArray(
						[
							A2(elm$html$Html$div, lineStyles, renderLastLineAsSpans),
							A2(
							elm$html$Html$div,
							_List_fromArray(
								[
							...
							_List_fromArray(
								[
									elm$html$Html$text(
									author$project$Main$toDecimalString(product))
								]))
						])) : A2(
					elm$html$Html$span,
					lineStyles,
					A2(author$project$Main$renderStringAsSpans, model, line)),
					A2(
					elm$html$Html$span,
					_List_Nil,
					(isLastLine && showingCalculation) ? _List_fromArray(
						[
							A2(
							elm$html$Html$span,
							_List_Nil,
							author$project$Main$renderCalculationSpans(model))
						]) : _List_Nil)
				]));
	});
...
var author$project$Main$view = function (model) {
	var rowDivs = elm$core$Array$toList(
		A2(
			elm$core$Array$indexedMap,
			F2(
				function (i, line) {
					return A3(author$project$Main$renderRowDiv, model, i, line);
				}),
			model.triangle));
	var displayToggleBlocks = elm$core$Array$length(model.triangle) > 8;
	var displayLineAtIndexAsFermatNumber = function (i) {
		return i && (author$project$Main$isPowerOf2(i) && (!_Utils_eq(
			i,
			elm$core$Array$length(model.triangle) - 1)));
	};
	var fermatNumbers = A2(
		elm$core$List$map,
		...
		A2(
			...
			function (_n0) {
				var i = _n0.a;
				var line = _n0.b;
				return displayLineAtIndexAsFermatNumber(i);
			},
			elm$core$Array$toIndexedList(model.triangle)));
	var fermatNumberDivs = A2(
		elm$core$List$map,
		function (line) {
			return A2(
				elm$html$Html$div,
				...
				_List_fromArray(
					[
						elm$html$Html$text(
						line + (' = ' + author$project$Main$toDecimalString(line)))
					]));
		},
		fermatNumbers);
	var buttonsContainerDiv = A2(
		elm$html$Html$div,
		_List_Nil,
		elm$core$List$concat(
			_List_fromArray(
				[
					...
					displayToggleBlocks ? _List_fromArray(
					[
						A2(
						elm$html$Html$button,
						_List_fromArray(
							[
								elm$html$Html$Events$onClick(author$project$Main$ToggleBlocks)
							]),
						_List_fromArray(
							[
								elm$html$Html$text('Toggle Blocks')
							]))
					]) : _List_Nil,
					_List_fromArray(
					[
				...
				elm$core$List$concat(
					_List_fromArray(
						[
							_List_fromArray(
							[
								elm$html$Html$text('Fermat numbers used:')
							]),
							fermatNumberDivs
						])))
			]));
			...
			[
				...
				_List_fromArray(
					[
						...
						A2(elm$html$Html$Attributes$style, 'height', '25rem')
					]),
				rowDivs)
			]));
};
