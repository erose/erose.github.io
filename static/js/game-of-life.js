...
var _user$project$Main$neighborhood = function (_p0) {
	var _p1 = _p0;
...
var _user$project$Main$numberOfLivingNeighbors = F2(
	function (point, board) {
		var isNeighborLiving = function (neighborPoint) {
			var _p3 = A2(_elm_lang$core$Dict$get, neighborPoint, board);
			if (_p3.ctor === 'Just') {
				return _p3._0;
			} else {
				return false;
		...
		var livingNeighbors = A2(
			_elm_lang$core$List$filter,
			isNeighborLiving,
			_user$project$Main$neighborhood(point));
		return _elm_lang$core$List$length(livingNeighbors);
	});
var _user$project$Main$determineLifeOrDeath = F3(
	function (board, point, isAlive) {
		var _p4 = A2(_user$project$Main$numberOfLivingNeighbors, point, board);
		switch (_p4) {
			case 0:
				return false;
			case 1:
...
var _user$project$Main$stepSimulation = function (board) {
	return A2(
		_elm_lang$core$Dict$map,
		_user$project$Main$determineLifeOrDeath(board),
		board);
};
var _user$project$Main$toggleCell = function (maybeIsAlive) {
	var _p5 = maybeIsAlive;
	if (_p5.ctor === 'Just') {
...
var _user$project$Main$initialBoard = function (sideLength) {
	...
	return _elm_lang$core$Dict$fromList(
		A2(
			_elm_lang$core$List$map,
			function (point) {
				return {ctor: '_Tuple2', _0: point, _1: false};
			},
			A2(
				_user$project$Main$cartesianProduct,
				A2(_elm_lang$core$List$range, 0, width),
				A2(_elm_lang$core$List$range, 0, height))));
};
var _user$project$Main$cellsOnASide = 50;
var _user$project$Main$init = {
	ctor: '_Tuple2',
	_0: {
		board: _user$project$Main$initialBoard(_user$project$Main$cellsOnASide),
		paused: true
	},
...
var _user$project$Main$renderBoard = function (board) {
	return A2(
		_elm_lang$core$List$map,
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$width(boardSizeInPixels),
					_1: {
						ctor: '::',
				...
				_user$project$Main$renderBoard(model.board)),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$div,
